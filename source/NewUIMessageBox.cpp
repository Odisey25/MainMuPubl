...
void SEASON3B::CNewUIMessageBoxMng::LoadImages() // Tí kiểm tra ở đây
{
	...
	LoadBitmap("Interface\\GFx\\Esc\\IMAGE_MSGBOX_BTN_ESC.tga", IMAGE_MSGBOX_BTN_ESC, GL_LINEAR);
...
void SEASON3B::CNewUIMessageBoxMng::UnloadImages()
{
	...
	DeleteBitmap(IMAGE_MSGBOX_BTN_ESC);

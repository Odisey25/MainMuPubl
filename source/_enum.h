...
// character start
enum { CHARACTER_NONE = 0, CHARACTER_RENDER_OBJ, CHARACTER_ANIMATION };
...
enum {
  ...
  MODEL_phoenix_shot_effect1,
  MODEL_phoenix_shot_effect2,
  MODEL_phoenix_shot_effect3,
  MODEL_ARMORINVEN_74,
...
// inventory start
enum { PSHOPWNDTYPE_NONE = -1, PSHOPWNDTYPE_SALE = 1, PSHOPWNDTYPE_PURCHASE };
...
enum { REVIVAL_NONE = 0, REVIVAL_DARKHORSE, REVIVAL_DARKSPIRIT, REVIVAL_END };
...
enum { TYPE_OBSERVER = 0, TYPE_GUILD_SOLDIER, TYPE_GUILD_COMMANDER };
// csmapinterface end
...
enum eGEMINDEXTYPE { eGEM_NAME, eGEM_INDEX, eGEM_END };

enum _GEMTYPE { NOGEM = -1, CELE = 0, SOUL = 1, COMCELE = 2, COMSOUL = 3 };
...
enum _STATE { STATE_READY, STATE_HOLD, STATE_END };
...
enum eBuffState {
  ...
  EFFECT_PREMIUM_BUFF11 = 207,
  EFFECT_PREMIUM_BUFF12 = 208,
  EFFECT_PREMIUM_BUFF13 = 209,
  EFFECT_CUSTOM_BUFF1 = 211,
  EFFECT_CUSTOM_BUFF2 = 216,
  EFFECT_CUSTOM_BUFF3 = 217,
  EFFECT_CUSTOM_BUFF4 = 212,
  EFFECT_CUSTOM_BUFF5 = 218,
  EFFECT_CUSTOM_BUFF6 = 219,
  EFFECT_CUSTOM_BUFF7 = 213,
  EFFECT_CUSTOM_BUFF8 = 214,
  EFFECT_CUSTOM_BUFF9 = 215,
  EFFECT_CUSTOM_BUFF10 = 231,
  EFFECT_CUSTOM_BUFF11 = 232,
  EFFECT_CUSTOM_BUFF12 = 233,
  EFFECT_CUSTOM_BUFF13 = 234,
  EFFECT_CUSTOM_BUFF14 = 235,
  EFFECT_CUSTOM_BUFF15 = 236,
  eBuff_Count,
};

...
void Draw_RenderObject(OBJECT* o, bool Translate, int Select, int ExtraMon)
{
	...
	if ((EditFlag != EDIT_NONE) || (EditFlag == EDIT_NONE && o->HiddenMesh != -2))
	{
		...
		if (gCustomPet2.GetInfoPetType(o->Type - MODEL_ITEM) == 5 && gCustomPet2.GetInfoPetEffect(o->Type - MODEL_ITEM)) // Effect Sói Ở Đây
		{
		...
		else if (o->Type == MODEL_MONSTER01 + 168)
		{
			...
			else if (o->Type == MODEL_FENRIR_BLACK || o->Type == MODEL_FENRIR_BLUE || o->Type == MODEL_FENRIR_RED || o->Type == MODEL_FENRIR_GOLD /*|| gCustomPet2.GetInfoPetType(o->Type - MODEL_ITEM) == 5*/)
			{
				vec3_t vLight, vPos, vPosition;
				float fLuminosity = (float)sinf((WorldTime) * 0.002f) * 0.2f;
...
void RenderPartObjectBody(BMD* b, OBJECT* o, int Type, float Alpha, int RenderType)
{
	...
	else if (Type == MODEL_WING + 37 || gCustomWing.CheckCustomWingByItem(Type - MODEL_ITEM) && !gCustomWing.CheckCustomWingByModelType(Type - MODEL_ITEM, 1))	// ½Ã°ø³¯°³(¹ý»ç)
	{
		Vector(1.f, 1.f, 1.f, b->BodyLight);
		b->RenderBody(RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, o->HiddenMesh);
	}
	...
	//===Sum Effect ArchangelusWeapon_render eArchangelusWeapon 
	else if (Type == MODEL_STAFF + 36)
	{
		...
		glColor3fv(b->BodyLight);
		b->RenderMesh(0, 64, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, eArchangelusWeapon);
		Vector(1.f, 1.f, 1.f, b->BodyLight);
	...
	else if (g_CMonkSystem.EqualItemModelType(Type) == MODEL_SWORD + 35) //ok
	{
		...
		b->RenderBody(RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV);
		b->RenderMesh(0, RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV);
		b->RenderMesh(0, RENDER_BRIGHT, o->Alpha * fLumi, 0, o->BlendMeshLight * fLumi, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, ePhoneix);

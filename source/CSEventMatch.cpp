...
void CSDevilSquareMatch::RenderMatchResult ( void )
{
	...
	g_pRenderText->RenderText( xPos[2] + 10, yPos, GlobalText[680], xPos[3]-xPos[1], RT3_SORT_CENTER );
	g_pRenderText->RenderText( xPos[3] + 10, yPos, GlobalText[682], xPos[4]-xPos[3], RT3_SORT_CENTER );
	g_pRenderText->RenderText( xPos[4] + 5, yPos, GlobalText[683], xPos[5]-xPos[4], RT3_SORT_CENTER );
	g_pRenderText->RenderText( xPos[5] + 5, yPos, GlobalText[684], xPos[5]-xPos[5], RT3_SORT_CENTER);
	yPos += 22;

...
namespace SEASON3B
{
	...
	public:
		...
		void SEASON3B::CNewUIButton::RenderBitmapHD(GLuint imgindex, float x, float y, float width, float height, float su, float sv, float uw, float vh , bool bClickEffect = false);
	private:
		void Initialize();
		void Destroy();

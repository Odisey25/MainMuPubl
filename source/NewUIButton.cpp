...
void SEASON3B::CNewUIButton::RenderBitmapHD(GLuint imgindex, float x, float y, float width, float height,float su, float sv, float uw, float vh, bool bClickEffect)
{

	RenderBitmap(imgindex, x, y, width, height, su / Bitmaps[imgindex].Width, sv / Bitmaps[imgindex].Height,uw / Bitmaps[imgindex].Width, vh / Bitmaps[imgindex].Height, 1, 1, 0.0);

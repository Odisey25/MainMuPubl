...
protected:
	...
	void CCharMakeWin::RenderCharacterUI(int movex, int movey, int& SelectedClass, float& CharacterDisplayTime, int classList[], int classCount);
	void RenderImageMakeChar(GLuint Image, float x, float y, float width, float height, float su, float sv, float uw, float vh);

...
void CreateArrow(CHARACTER* c, OBJECT* o, OBJECT* to,WORD SkillIndex, WORD Skill, WORD SKKey)
{
	...
	else
	{
		...
		case MODEL_BOW + 18:
			CreateEffect(MODEL_ARROW_BEST_CROSSBOW, ArrowPos, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill); break;
			break;
		case MODEL_BOW + 19:CreateEffect(MODEL_ARROW_DRILL, ArrowPos, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill); break;
		default:
			if (gCustomBow.CheckCustomCross(Right - MODEL_ITEM) == true) // SkillEffect Crossbow
			{
				CreateEffect(gCustomBow.GetCustomSkill(Right - MODEL_ITEM), ArrowPos, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill); break;
			}
			break;
		}
		switch (Left)
		...
		default:
			...
			{
				CreateEffect(gCustomBow.GetCustomSkill(Left - MODEL_ITEM), o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);
			}
			break;
		}
	}

...
namespace SEASON3B
{
	...
	public:
		...
		//void CNewUIMyInventory::ButtonInventory(CNewUIButton* m_Btn, int imgindex, int x, int y, int sx, int sy, bool overflg, bool isimgwidth, bool bClickEffect, bool MoveTxt, unicode::t_string btname, unicode::t_string tooltiptext, bool istoppos);
		void CNewUIMyInventory::ButtonInventory(CNewUIButton* m_Btn, int imgindex, int x, int y, int width, int height, float su, float sv, float uw, float vh, bool overflg, bool bClickEffect, bool istoppos);

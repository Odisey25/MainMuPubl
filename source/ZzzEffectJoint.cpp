...
void MoveJoint(JOINT* o, int iIndex)
{
	...
	case BITMAP_JOINT_THUNDER:
		...
		break;    // Dấu 2222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222
	case BITMAP_JOINT_THUNDER + 1:
		if (o->SubType == 0)
		{
			if (o->LifeTime > 15)
	...
	case BITMAP_FLARE + 1:
		...
		else
		{
			...
			if (o->Target->Live)
			{
				...
				if (o->LifeTime < 15)
				{
					VectorScale(o->Light, powf(1.f / 1.5f, FPS_ANIMATION_FACTOR), o->Light); // Dấu 444444444444444444444444444444444444444444444444444
				}
			}
			else
			{
	...
	case BITMAP_LIGHT:
		...
		VectorScale(o->Light, powf(1.f / 1.2f, FPS_ANIMATION_FACTOR), o->Light);
		break;
	case BITMAP_PIERCING: //dấu 5555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555
		if (o->SubType == 0)
		{
			if (o->LifeTime > 9)
			{

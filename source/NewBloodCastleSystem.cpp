...
void CNewBloodCastleSystem::RenderMatchResult ( void )
{
    ...
    if ( m_iNumResult )
    {
		g_pRenderText->RenderText(x + 2,yPos,GlobalText[857], 0, 0, RT3_WRITE_CENTER); 
    }
    else
    {
		g_pRenderText->RenderText(x + 2,yPos,GlobalText[859], 0, 0, RT3_WRITE_CENTER); 

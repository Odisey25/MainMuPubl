...
#define MAX_INVENTORY_EXT_COUNT 4 // Số Lượng Thùng Đồ Mở Rộng
...
#define BOSS_GUILD								1
#define CTCMINI									1
#define CB_ANTIHACKGGNEW						1
#define CUSTOM_NGUYENTOBB						1
#define LAGCHOI									1
#define NEWWARE									1

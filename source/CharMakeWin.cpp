...
void CCharMakeWin::RenderCreateCharacter()
{
	...
	int width = DisplayWin * 0.5 - 70;
	int height = DisplayHeight * 0.5 - 150;
	int movex;
	int movey;
	...
	case 3: WindowWidth = 1366; WindowHeight = 768;
		movex = 220; movey = 90;


		break;
	case 5: WindowWidth = 1400; WindowHeight = 900;
		movex = 230; movey = 140;

		break;//Done
	case 6: WindowWidth = 1600; WindowHeight = 900;
		movex = 280; movey = 140;

		
		break;//Done
	case 7: WindowWidth = 1680; WindowHeight = 1050;
		movex = 320; movey = 190;

		

		break;//Done
	case 8: WindowWidth = 1920; WindowHeight = 1080;
		movex = 390; movey = 210;


		break;//Done
	default: WindowWidth = 1920; WindowHeight = 1080; movex = 350; movey = 210; break;//Done
	}


	BeginOpengl(m_winBack.GetXPos() - movex, m_winBack.GetYPos() - movey, 410 / g_fScreenRate_x, 335 / g_fScreenRate_y);
